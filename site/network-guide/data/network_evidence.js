window.NETWORK_EVIDENCE = {
  ...
  "packages": [
    ...
    },
    {
      ...
      "description": "A collection of production-grade custom drivers for Third Reality Zigbee devices. Select and install only the drivers you need (Contact, Motion, Night Light, Power Plug with Metering, and Temp/Humidity Display/Non-Display sensors).",
