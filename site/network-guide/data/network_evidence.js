window.NETWORK_EVIDENCE = {
  ...
  "packages": [
    ...
    },
    {
      ...
      "description": "Visual drag and drop rules engine.",
      "documentationUrl": "https://github.com/bptworld/Hubitat",
    ...
    },
    {
      ...
      "description": "Local Voice Control for Hubitat!  Requires an always on win PC.",
      "documentationUrl": "https://github.com/bptworld/Hubitat",
    ...
    },
    {
      ...
      "description": "Fork of kkossev's Tuya Zigbee Valve driver adding SONOFF SWV-ZF2 dual-port support: independent per-port child devices, per-port irrigation history and auto-off timers, and a per-run open(duration) command.",
